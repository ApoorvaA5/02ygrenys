    ...
    <p className="text-gray-400">+91 94887 77812</p>
      ...
      <div className="space-y-2">
        <div className="flex items-center space-x-2">
          <img src={india} alt="India" className="w-8 h-5 object-cover" />
          <p className="text-gray-400">mail@indiasynergy.com</p>
        </div>

        <div className="flex items-center space-x-2">
          <img src={usa} alt="USA" className="w-8 h-5 object-cover" />
          <p className="text-gray-400">usa@indiasynergy.com</p>
        </div>

        <div className="flex items-center space-x-2">
          <img src={eruope} alt="Europe" className="w-8 h-5 object-cover" />
          <p className="text-gray-400">europe@indiasynergy.com</p>
        </div>

        <div className="flex items-center space-x-2">
          <img src={canada} alt="Canada" className="w-8 h-5 object-cover" />
          <p className="text-gray-400">canada@indiasynergy.com</p>
        </div>

        <div className="flex items-center space-x-2">
          <img src={uk} alt="UK" className="w-8 h-5 object-cover" />
